                        ...
                        <div class="d-flex algin-center space-between">
                            ...
                            ?>
                                <div class="order__detail--action">
                                    ...
                                    ?>
                                    <a href="modules/order/xuly.php?confirm=1&order_code=<?php echo $order_code ?>" class="btn btn-outline-dark btn-fw">Duyệt đơn</a>
                                    <?php
                                    } else {
                                    ?>
                                    <a href="modules/order/xuly.php?rollback=1&order_code=<?php echo $order_code ?>" class="btn btn-outline-dark btn-fw">Trả hàng</a>
                                    <?php
                                    }
                                    ?>
                                ...
                                <div class="order_status">Tình trạng đơn: <span class="col-span"><?php echo format_order_status($status['order_status']); ?></span></div>
                            <?php
                            }
                            ?>
                        </div>
